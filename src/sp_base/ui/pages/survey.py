...
from sp_base.models.config_models import DeviceProfile
...
from sp_base.services.drivers import create_driver, list_drivers
...
def survey_page() -> None:
    ...
    with page_layout("Survey-In"):
        ...
        async def _commit_fixed_base(
            ...
            from sp_base.models.device_models import FixedBaseConfig
        ...
        async def _start_survey_in() -> None:
            nonlocal svin_timer
            from sp_base.models.device_models import SurveyInConfig
